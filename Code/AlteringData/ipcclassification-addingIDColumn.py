...
PATH = 'C:/Users/HiguchiD/Documents/virtualenv/Data/IPCClassification'  
...
cur.execute("SELECT MAX(id) FROM patents_pt_ipc_classification") # will need separate script for each table
