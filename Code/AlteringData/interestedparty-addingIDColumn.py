...
PATH = 'C:/Users/HiguchiD/Documents/virtualenv/Data/InterestedParty'  
...
cur.execute("SELECT MAX(id) FROM patents_pt_interested_party") # will need separate script for each table
