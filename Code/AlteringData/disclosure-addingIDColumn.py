...
PATH = 'C:/Users/HiguchiD/Documents/virtualenv/Data/Disclosure'  
...
cur.execute("SELECT MAX(id) FROM patents_pt_disclosure") # will need separate script for each table
