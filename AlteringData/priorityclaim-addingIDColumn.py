...
PATH = 'C:/Users/HiguchiD/Documents/virtualenv/Data/PriorityClaim'  
...
cur.execute("SELECT MAX(id) FROM patents_pt_priority_claim") # will need separate script for each table
